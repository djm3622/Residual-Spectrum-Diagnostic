...
class WNOConfig(ModelConfig):
    ...
    base_resolution: Optional[List[int]] = None


class WNO_Small2d(WNOConfig):
    data_channels: int = 1
    out_channels: int = 1
    n_modes: List[int] = [16, 16]
